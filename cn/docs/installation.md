...
[Create React App](http://github.com/facebookincubator/create-react-app) ([中文](https://github.com/gafish/gafish.github.com/issues/16))是用来创建一个新的 React 单页应用的最佳方式。它已经为你设置好了开发环境，以便你可以使用最新的 `JavaScript` 特性，它提供一种不错的开发体验，并且可以优化你的生产环境应用。
